-- ================================================
-- COMPREHENSIVE FIX: Resolve all RLS and trigger issues
...
-- Ensure anon can insert into schools (critical for registration)
...
-- ================================================
-- Run these separately after applying the migration to verify:

-- Check policies on users table:
-- SELECT policyname, roles, cmd, qual, with_check FROM pg_policies WHERE tablename = 'users';

-- Check policies on schools table:
-- SELECT policyname, roles, cmd, qual, with_check FROM pg_policies WHERE tablename = 'schools';
